                                  ...
                                  @foreach($permissions as $permission)
                                      ...
                                      @endif
                                          <div class="form-check mb-1">
                                              <input name="permissions[]" @if($role->hasPermissionTo($permission)) checked @endif class="form-check-input" value="{{$permission->name}}" type="checkbox" id="checkBoxId_{{$permission->id}}">
